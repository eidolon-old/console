...
/**
 * InfoOutputFormatterStyle Spec
 *
 * @author Elliot Wright <elliot@elliotwright.co>
 */
class InfoOutputFormatterStyleSpec extends FunSpec with BeforeAndAfter with MockitoSugar {
  var chroma: Chroma = _
  ...
  describe("eidolon.console.output.formatter.style.InfoOutputFormatterStyle") {
    describe("applyStyle()") {
      it("should apply a style") {
        val style = new InfoOutputFormatterStyle(chroma)
