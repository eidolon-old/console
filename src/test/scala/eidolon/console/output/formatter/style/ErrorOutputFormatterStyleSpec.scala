...
/**
 * ErrorOutputFormatterStyle Spec
 *
 * @author Elliot Wright <elliot@elliotwright.co>
 */
class ErrorOutputFormatterStyleSpec extends FunSpec with BeforeAndAfter with MockitoSugar {
  var chroma: Chroma = _
  ...
  describe("eidolon.console.output.formatter.style.ErrorOutputFormatterStyle") {
    describe("applyStyle()") {
      it("should apply a style") {
        val style = new ErrorOutputFormatterStyle(chroma)
